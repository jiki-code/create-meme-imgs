...
type UploadColorPickerProps = {
  ...
  onBackgroundChange: (bg: RGBAColor | string, bg2?: void) => void; // Chỉ nên dùng RGBAColor
};
              ...
              <div className="flex pt-2 flex-nowrap gap-1 w-full">
                {colorBackground.map((color) => (
                  <button
                    ...
                    onClick={() =>
                      onBackgroundChange(color, setBackgroundColor(color))
                    }
                  />
                ))}
              </div>
              ...
              <div className="pt-2">
                <input
                  ...
                  onChange={(e) => {
                    ...
                    onBackgroundChange((prev: RGBAColor) => {
                      if (!prev) return `rgba(0,0,0,${opacity})`; // fallback
